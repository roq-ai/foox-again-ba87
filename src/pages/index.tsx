  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Step into Foox again - Your ultimate gateway to a vibrant marketplace connecting freelancers and companies offering jobs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Step into Foox again - Your ultimate gateway to a vibrant marketplace connecting freelancers and companies offering jobs.`}
            </Text>
            <Box
